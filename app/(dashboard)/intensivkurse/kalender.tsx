...
// Generisches Kurs-Interface für Kalender (exportiert für Wiederverwendung)
export interface KursForKalender {
  id: number
  name: string
  fach: Fach
  beschreibung: string
...
interface IntensivkurseKalenderProps {
...
export function IntensivkurseKalender({ kurse, onKursClick, onAnmelden }: IntensivkurseKalenderProps) {
