...
| token_endpoint_auth_method | text |  | false |  |  |  |
...
| oauth_clients_token_endpoint_auth_method_check | CHECK | CHECK ((token_endpoint_auth_method = ANY (ARRAY['client_secret_basic'::text, 'client_secret_post'::text, 'none'::text]))) |
