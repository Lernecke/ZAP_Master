...
- [ ] **BMS-Halbjahreskurs entscheiden.** Freigegebenen Detailinhalt liefern oder das Angebot ausdrücklich deaktivieren. Keine Detailseite aus anderen Kursen erfinden; die vorhandenen BMS-Angebote bleiben davon unabhängig.
...
- [ ] **Über-uns-Kennzahlen ersetzen oder entfernen.** Die als Platzhalter markierten Zahlen nur mit belegbaren Werten veröffentlichen; andernfalls die Zahlensektion ausblenden oder ohne Zahlen formulieren.
